...
namespace QUT.PERWAPI
{
    ...
    internal class PEReader : BinaryReader
    {
        ...
        readonly uint[] tableLengths = new uint[MetaData.NumMetaDataTables];
        readonly MetaData md = new MetaData();
        MetaDataStringStream userstring;
        MetaDataInStream blob, strings, guid;
        readonly Sentinel sentinel = new Sentinel();
        readonly Pinned pinned = new Pinned();
        //CorFlags corFlags;
        ...
        //uint fileAlign = 0;
        //char[] verString;
        readonly bool refsOnly = false;
        long[] tableStarts;
        ResolutionScope thisScope;
        readonly PEFileVersionInfo verInfo = new PEFileVersionInfo();
