...
namespace QUT.PERWAPI
{
    ...
    internal class PEReader : BinaryReader
    {
        ...
        private uint[] DataDirectoryRVA = new uint[16];
        private uint[] DataDirectorySize = new uint[16];
        private uint[] streamOffsets;
        private uint[] streamSizes;
        private String[] streamNames;
        private readonly TableRow[][] tables = new TableRow[MetaData.NumMetaDataTables][];
        private readonly uint[] tableLengths = new uint[MetaData.NumMetaDataTables];
        private readonly MetaData md = new MetaData();
        private MetaDataStringStream userstring;
        private MetaDataInStream blob;
        private MetaDataInStream strings;
        private MetaDataInStream guid;
        private readonly Sentinel sentinel = new Sentinel();
        private readonly Pinned pinned = new Pinned();
        //CorFlags corFlags;
        private uint metaDataRVA = 0;
        private uint metaDataSize = 0;
        private uint flags = 0;
        private uint entryPoint = 0;
        private uint resourcesRVA = 0;
        private uint resourcesSize = 0;
        private uint strongNameRVA = 0;
        private uint strongNameSize = 0;
        private uint vFixupsRVA = 0;
        private uint vFixupsSize = 0;
